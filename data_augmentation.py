...
images_path="landcover/images" #path to original images
masks_path = "landcover/masks"
img_augmented_path="augmented/images" # path to store aumented images
msk_augmented_path="augmented/masks" # path to store aumented images
...
#     print(i)
    ...
    i =i+1
    if k>=int(images_to_generate/len(images)):
        j += 1
        k = 1
    else:
        k +=1
